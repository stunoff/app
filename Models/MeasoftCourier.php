...
class MeasoftCourier
{
    ...
    public function orderCreate(array $order = array(), array $items = array())
    {
        ...
        $result = $this->sendRequest($this->makeXML('neworder', array('order' => array(
            'attributes' => array('orderno' => $order['orderno']),
            'value' => $data,
        ))));
    ...
    public function orderStatus($number)
    {
        ...
        $result = $this->sendRequest($this->makeXML('statusreq', array('orderno' => $number)));
